...
The built-in editor validates your ICU syntax in real time.
...
- **Edit** existing translations (on the branch, not the main project)
...
4. You now have an isolated workspace to add or edit keys.

### Working on a branch

When you open a branch, the translation editor works exactly like the main editor. All changes are scoped to the branch.
...
curl -H "Authorization: Bearer YOUR_API_KEY" \
  "https://transi-store.io/api/orgs/acme/projects/webapp/translations?locale=fr&format=json"
```
