...
- **Langue** — choisissez pour quelle langue du projet la traduction est affichée dans la colonne « Traduction par défaut ». La valeur par défaut est la langue principale du projet.
